...
const CREDITS = [
    {
        ...
        rows: [['Abdullah Sarder', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Abdullah Sarder', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Abdullah Sarder', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Abdullah Sarder'}
        >
            <div
